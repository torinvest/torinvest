<?php
/**
 * index.php - NEO CRYPTO DASH v5.0 ULTIMATE PRO AUTONOME
 * Dashboard Crypto IA 100% Autonome - Trading Automatique par Renforcement
 * 
 * Architecture Professionnelle Hostinger-Compatible:
 * ✅ Analyses IA automatiques en AJAX séquentiel (une par une toutes les 2s)
 * ✅ Ligne d'analyse dédiée sous chaque crypto (pas d'erreur de layout)
 * ✅ Time limit respecté avec queue intelligente
 * ✅ Messages uniquement via AJAX Toast (plus aucun alert navigateur)
 * ✅ Bouton "FULL AUTO" : analyses, RL, trading, blog en chaîne
 * ✅ Prompts IA ultra-professionnels optimisés
 * ✅ Workflow optimisé et incohérences corrigées
 * ✅ Trading déclenché à partir de score >= 60 (et non 65)
 * ✅ Site 100% autonome - l'IA gère tout toute seule
 */
...
debugLog('=== INDEX.PHP v5.0 AUTONOME STARTED ===', 'INFO');
...
try {
    ...
    // Vérifier la fraîcheur des analyses et préparer la queue auto
    $freshCount = 0;
    $needAnalysis = [];
    ...
    // Encoder la queue pour le JS
    $autoAnalysisQueue = json_encode($needAnalysis);
    ...
    // Seuils RL - ACHAT À PARTIR DE 60 (et non 65)
    ...
    $buyScore = 60; // Force à 60 pour trading plus actif
    $sellScore = 35;
