...
for page in dashboard.html calendar.html calendar-day.html login.html fondamental.html journal.html; do
...
mkdir -p "$PATCHES_DIR"
for f in routes-progress.js middleware-require-subscribed.js routes-calendar.js forge-unlock-server.js forge-progress-rules.js routes-formation-auth.js routes-fondamental-bridge.js routes-journal-bridge.js fondamental-bridge-lib.js formation-users-lib.js accompagnement-worker-lib.js; do
