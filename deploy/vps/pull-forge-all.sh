...
for script in wire-formation-server-patches.js verify-formation-live.sh finish-formation-vps-setup.sh recover-formation-server.sh repair-server-broken-wire.js fix-trust-proxy.js fix-rate-limit-validate.js fix-proxy-and-ratelimit.js; do
